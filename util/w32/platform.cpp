#define LT_API
#define LT_FORWARD(x) x
#define LT_EXTERN_FORWARD extern "C"
#define LT_DIRECT_API
#include <light.h>
...
int ConvertVirtualKeyCode(int key) {
	switch (key) {
		case 0x08: return LT_SCANCODE_BACKSPACE;
		case 0x09: return LT_SCANCODE_TAB;
		case 0x0D: return LT_SCANCODE_ENTER;
		case 0x13: return LT_SCANCODE_PAUSE;
		case 0x14: return LT_SCANCODE_CAPS_LOCK;
		case 0x1B: return LT_SCANCODE_ESCAPE;
		case 0x20: return LT_SCANCODE_SPACE;
		case 0x21: return LT_SCANCODE_PAGE_UP;
		case 0x22: return LT_SCANCODE_PAGE_DOWN;
		case 0x23: return LT_SCANCODE_END;
		case 0x24: return LT_SCANCODE_HOME;
		case 0x25: return LT_SCANCODE_LEFT_ARROW;
		case 0x26: return LT_SCANCODE_UP_ARROW;
		case 0x27: return LT_SCANCODE_RIGHT_ARROW;
		case 0x28: return LT_SCANCODE_DOWN_ARROW;
		case 0x2D: return LT_SCANCODE_INSERT;
		case 0x2E: return LT_SCANCODE_DELETE;
		case 0x30: return LT_SCANCODE_0;
		case 0x31: return LT_SCANCODE_1;
		case 0x32: return LT_SCANCODE_2;
		case 0x33: return LT_SCANCODE_3;
		case 0x34: return LT_SCANCODE_4;
		case 0x35: return LT_SCANCODE_5;
		case 0x36: return LT_SCANCODE_6;
		case 0x37: return LT_SCANCODE_7;
		case 0x38: return LT_SCANCODE_8;
		case 0x39: return LT_SCANCODE_9;
		case 0x41: return LT_SCANCODE_A;
		case 0x42: return LT_SCANCODE_B;
		case 0x43: return LT_SCANCODE_C;
		case 0x44: return LT_SCANCODE_D;
		case 0x45: return LT_SCANCODE_E;
		case 0x46: return LT_SCANCODE_F;
		case 0x47: return LT_SCANCODE_G;
		case 0x48: return LT_SCANCODE_H;
		case 0x49: return LT_SCANCODE_I;
		case 0x4A: return LT_SCANCODE_J;
		case 0x4B: return LT_SCANCODE_K;
		case 0x4C: return LT_SCANCODE_L;
		case 0x4D: return LT_SCANCODE_M;
		case 0x4E: return LT_SCANCODE_N;
		case 0x4F: return LT_SCANCODE_O;
		case 0x50: return LT_SCANCODE_P;
		case 0x51: return LT_SCANCODE_Q;
		case 0x52: return LT_SCANCODE_R;
		case 0x53: return LT_SCANCODE_S;
		case 0x54: return LT_SCANCODE_T;
		case 0x55: return LT_SCANCODE_U;
		case 0x56: return LT_SCANCODE_V;
		case 0x57: return LT_SCANCODE_W;
		case 0x58: return LT_SCANCODE_X;
		case 0x59: return LT_SCANCODE_Y;
		case 0x5A: return LT_SCANCODE_Z;
		case 0x5B: return LT_SCANCODE_LEFT_FLAG;
		case 0x5C: return LT_SCANCODE_LEFT_FLAG;
		case 0x5D: return LT_SCANCODE_CONTEXT_MENU;
		case 0x5F: return LT_SCANCODE_ACPI_SLEEP;
		case 0x70: return LT_SCANCODE_F1;
		case 0x71: return LT_SCANCODE_F2;
		case 0x72: return LT_SCANCODE_F3;
		case 0x73: return LT_SCANCODE_F4;
		case 0x74: return LT_SCANCODE_F5;
		case 0x75: return LT_SCANCODE_F6;
		case 0x76: return LT_SCANCODE_F7;
		case 0x77: return LT_SCANCODE_F8;
		case 0x78: return LT_SCANCODE_F9;
		case 0x79: return LT_SCANCODE_F10;
		case 0x7A: return LT_SCANCODE_F11;
		case 0x7B: return LT_SCANCODE_F12;
		case 0x90: return LT_SCANCODE_NUM_LOCK;
		case 0x91: return LT_SCANCODE_SCROLL_LOCK;
		case 0xA0: return LT_SCANCODE_LEFT_SHIFT;
		case 0xA1: return LT_SCANCODE_RIGHT_SHIFT;
		case 0xA2: return LT_SCANCODE_LEFT_CTRL;
		case 0xA3: return LT_SCANCODE_RIGHT_CTRL;
		case 0xA4: return LT_SCANCODE_LEFT_ALT;
		case 0xA5: return LT_SCANCODE_RIGHT_ALT;
		case 0xA6: return LT_SCANCODE_WWW_BACK;
		case 0xA7: return LT_SCANCODE_WWW_FORWARD;
		case 0xA8: return LT_SCANCODE_WWW_REFRESH;
		case 0xA9: return LT_SCANCODE_WWW_STOP;
		case 0xAA: return LT_SCANCODE_WWW_SEARCH;
		case 0xAB: return LT_SCANCODE_WWW_STARRED;
		case 0xAC: return LT_SCANCODE_WWW_HOME;
		case 0xAD: return LT_SCANCODE_MM_MUTE;
		case 0xAE: return LT_SCANCODE_MM_QUIETER;
		case 0xAF: return LT_SCANCODE_MM_LOUDER;
		case 0xB0: return LT_SCANCODE_MM_NEXT;
		case 0xB1: return LT_SCANCODE_MM_PREVIOUS;
		case 0xB2: return LT_SCANCODE_MM_STOP;
		case 0xB3: return LT_SCANCODE_MM_PAUSE;
		case 0xB4: return LT_SCANCODE_MM_EMAIL;
		case 0xBA: return LT_SCANCODE_PUNCTUATION_3;
		case 0xBB: return LT_SCANCODE_EQUALS;
		case 0xBC: return LT_SCANCODE_COMMA;
		case 0xBD: return LT_SCANCODE_HYPHEN;
		case 0xBE: return LT_SCANCODE_PERIOD;
		case 0xBF: return LT_SCANCODE_SLASH;
		case 0xC0: return LT_SCANCODE_PUNCTUATION_5;
		case 0xDB: return LT_SCANCODE_LEFT_BRACE;
		case 0xDC: return LT_SCANCODE_PUNCTUATION_1;
		case 0xDD: return LT_SCANCODE_RIGHT_BRACE;
		case 0xDE: return LT_SCANCODE_PUNCTUATION_4;
		default:   return 0;
	}
}
...
LRESULT CALLBACK WindowProcedure(HWND window, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	if (message == WM_CLOSE) {
		...
		EsMessage m = {};
		m.type = LT_MSG_WINDOW_RESIZED;
		RECT client;
		GetClientRect(window, &client);
		m.windowResized.content = LT_MAKE_RECTANGLE(0, client.right, 0, client.bottom);
		...
		EsMessageMutexRelease();
		EsMessage m;
		m.type = LT_MSG_WINDOW_DEACTIVATED;
		SendInputMessage(element, &m);
	} else if (message == WM_SETFOCUS) {
		EsMessage m;
		m.type = LT_MSG_WINDOW_ACTIVATED;
		SendInputMessage(element, &m);
	} else if (message == WM_KEYDOWN || message == WM_KEYUP || message == WM_SYSKEYDOWN || message == WM_SYSKEYUP) {
		EsMessage m = {};
		m.type = (message == WM_KEYDOWN || message == WM_SYSKEYDOWN) ? LT_MSG_KEY_DOWN : LT_MSG_KEY_UP;
		...
		if (m.keyboard.scancode == LT_SCANCODE_F4 && m.keyboard.alt) SendMessage(window, WM_CLOSE, 0, 0);
		...
		EsMessage m = {};
		if (message == WM_LBUTTONDOWN) m.type = LT_MSG_MOUSE_LEFT_DOWN;
		if (message == WM_LBUTTONUP)   m.type = LT_MSG_MOUSE_LEFT_UP;
		if (message == WM_RBUTTONDOWN) m.type = LT_MSG_MOUSE_RIGHT_DOWN;
		if (message == WM_RBUTTONUP)   m.type = LT_MSG_MOUSE_RIGHT_UP;
		if (message == WM_MBUTTONDOWN) m.type = LT_MSG_MOUSE_MIDDLE_DOWN;
		if (message == WM_MBUTTONUP)   m.type = LT_MSG_MOUSE_MIDDLE_UP;
		POINT point, screen;
		GetCursorPos(&point);
		screen = point;
		ScreenToClient(window, &point);
		...
		EsMessage m;
		m.type = LT_MSG_WINDOW_DESTROYED;
		SendInputMessage(element, &m);
...
uintptr_t _APISyscall(uintptr_t type, uintptr_t argument0, uintptr_t argument1, uintptr_t unused, uintptr_t argument2, uintptr_t argument3) {
	if (type == LT_SYSCALL_PRINT) {
	...
	} else if (type == LT_SYSCALL_GET_SYSTEM_CONSTANTS) {
		uint64_t *systemConstants = (uint64_t *) argument0;
		LARGE_INTEGER performanceFrequency;
		QueryPerformanceFrequency(&performanceFrequency);
		systemConstants[LT_SYSTEM_CONSTANT_TIME_STAMP_UNITS_PER_MICROSECOND] = performanceFrequency.QuadPart / 1000000;
		systemConstants[LT_SYSTEM_CONSTANT_UI_SCALE] = 100; // TODO Proper scaling support.
	} else if (type == LT_SYSCALL_ALLOCATE) {
		// TODO Protection.
		return (uintptr_t) VirtualAlloc(NULL, argument0, MEM_RESERVE | ((argument1 & LT_MEMORY_RESERVE_COMMIT_ALL) ? MEM_COMMIT : 0), PAGE_READWRITE);
	} else if (type == LT_SYSCALL_FREE) {
		VirtualFree((void *) argument0, 0, MEM_RELEASE);
	} else if (type == LT_SYSCALL_SYSTEM_CONFIGURATION_READ) {
		...
		object->close = [] (Object *) {};
		return (uintptr_t) object;
	} else if (type == LT_SYSCALL_READ_CONSTANT_BUFFER) {
	...
	} else if (type == LT_SYSCALL_OPEN_NODE) {
		...
		if (path[0] == '$') {
			...
			object->handle = CreateFileW(pathWide, 
					GENERIC_READ | ((flags & (LT_FILE_WRITE | LT_FILE_WRITE_EXCLUSIVE)) ? GENERIC_WRITE : 0),
					(flags & (LT_FILE_WRITE | LT_FILE_READ_SHARED)) ? (FILE_SHARE_READ | FILE_SHARE_READ)
					: (flags & LT_FILE_READ) ? FILE_SHARE_READ : 0, NULL, 
					(flags & LT_NODE_FAIL_IF_FOUND) ? CREATE_NEW : (flags & LT_NODE_FAIL_IF_NOT_FOUND) ? OPEN_EXISTING : CREATE_NEW,
	...
	} else if (type == LT_SYSCALL_MAP_OBJECT) {
		// TODO Protection.
	...
	} else if (type == LT_SYSCALL_OPEN_SHARED_MEMORY) {
		// TODO.
		return 0;
	} else if (type == LT_SYSCALL_GET_THREAD_ID) {
		// TODO Other threads and processes.
		return GetCurrentThreadId();
	} else if (type == LT_SYSCALL_SET_TLS) {
		TlsSetValue(threadLocalStorageIndex, (void *) argument0);
	} else if (type == LT_SYSCALL_GET_MESSAGE) {
		...
		if (!arrlen(messageQueue)) {
			return LT_ERROR_NO_MESSAGES_AVAILABLE;
		}
		
		*(_EsMessageWithObject *) argument0 = messageQueue[0];
		arrdel(messageQueue, 0);
	} else if (type == LT_SYSCALL_WAIT_MESSAGE) {
		// TODO Timeout.
		...
		allowSynchronousMessages = false;
	} else if (type == LT_SYSCALL_WINDOW_CREATE) {
		// TODO Other window types.
		
		Object *object = (Object *) HeapAlloc(heap, HEAP_ZERO_MEMORY, sizeof(Object));
		
		if (argument0 == LT_WINDOW_MENU) {
		...
		return (uintptr_t) object;
	} else if (type == LT_SYSCALL_POST_MESSAGE) {
		_EsMessageWithObject message;
		message.object = (void *) argument1;
		message.message = *(EsMessage *) argument0;
		arrput(messageQueue, message);
	} else if (type == LT_SYSCALL_WINDOW_SET_OBJECT) {
		Object *object = (Object *) argument0;
		SetWindowLongPtr(object->window, GWLP_USERDATA, argument2);
		RECT client;
		GetClientRect(object->window, &client);
		EsMessage message = {};
		message.type = LT_MSG_WINDOW_RESIZED;
		message.windowResized.content = LT_MAKE_RECTANGLE(0, client.right, 0, client.bottom);
		EsMessagePost((EsElement *) argument2, &message);
	} else if (type == LT_SYSCALL_WINDOW_SET_RESIZE_CLEAR_COLOR) {
	} else if (type == LT_SYSCALL_EMBED_WINDOW_SEND_MESSAGE) {
	...
	} else if (type == LT_SYSCALL_GET_CURSOR_POSITION) {
		POINT point = {};
		GetCursorPos(&point);
		EsPoint *result = (EsPoint *) argument0;
		result->x = point.x;
		result->y = point.y;
	} else if (type == LT_SYSCALL_WINDOW_GET_BOUNDS) {
		Object *object = (Object *) argument0;
	...
	} else if (type == LT_SYSCALL_WINDOW_SET_CURSOR) {
		if (cursor && cursor != blankCursor) {
			DestroyCursor(cursor);
		}
		
		switch ((EsCursorStyle) (argument3 >> 24)) {
			case LT_CURSOR_NORMAL           : cursor = LoadCursor(NULL, IDC_ARROW);    break;
			case LT_CURSOR_TEXT             : cursor = LoadCursor(NULL, IDC_IBEAM);    break;
			case LT_CURSOR_RESIZE_VERTICAL  : cursor = LoadCursor(NULL, IDC_SIZENS);   break;
			case LT_CURSOR_RESIZE_HORIZONTAL: cursor = LoadCursor(NULL, IDC_SIZEWE);   break;
			case LT_CURSOR_RESIZE_DIAGONAL_1: cursor = LoadCursor(NULL, IDC_SIZENESW); break;
			case LT_CURSOR_RESIZE_DIAGONAL_2: cursor = LoadCursor(NULL, IDC_SIZENWSE); break;
			case LT_CURSOR_SPLIT_VERTICAL   : cursor = LoadCursor(NULL, IDC_SIZEWE);   break;
			case LT_CURSOR_SPLIT_HORIZONTAL : cursor = LoadCursor(NULL, IDC_SIZENS);   break;
			case LT_CURSOR_HAND_HOVER       : cursor = LoadCursor(NULL, IDC_HAND);     break;
			case LT_CURSOR_HAND_DRAG        : cursor = LoadCursor(NULL, IDC_HAND);     break;
			case LT_CURSOR_HAND_POINT       : cursor = LoadCursor(NULL, IDC_HAND);     break;
			case LT_CURSOR_SCROLL_UP_LEFT   : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SCROLL_UP        : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SCROLL_UP_RIGHT  : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SCROLL_LEFT      : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SCROLL_CENTER    : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SCROLL_RIGHT     : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SCROLL_DOWN_LEFT : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SCROLL_DOWN      : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SCROLL_DOWN_RIGHT: cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_SELECT_LINES     : cursor = LoadCursor(NULL, IDC_ARROW);    break;
			case LT_CURSOR_DROP_TEXT        : cursor = LoadCursor(NULL, IDC_ARROW);    break;
			case LT_CURSOR_CROSS_HAIR_PICK  : cursor = LoadCursor(NULL, IDC_CROSS);    break;
			case LT_CURSOR_CROSS_HAIR_RESIZE: cursor = LoadCursor(NULL, IDC_CROSS);    break;
			case LT_CURSOR_MOVE_HOVER       : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_MOVE_DRAG        : cursor = LoadCursor(NULL, IDC_SIZEALL);  break;
			case LT_CURSOR_ROTATE_HOVER     : cursor = LoadCursor(NULL, IDC_ARROW);    break;
			case LT_CURSOR_ROTATE_DRAG      : cursor = LoadCursor(NULL, IDC_ARROW);    break;
			case LT_CURSOR_BLANK            : cursor = blankCursor;                    break;
			default                         : cursor = NULL;                           break;
		}

		SetCursor(cursor);
	} else if (type == LT_SYSCALL_WINDOW_SET_BITS) {
		Object *object = (Object *) argument0;
	...
	} else if (type == LT_SYSCALL_FORCE_SCREEN_UPDATE) {
	} else if (type == LT_SYSCALL_WINDOW_SET_BLUR_BOUNDS) {
		Object *object = (Object *) argument0;
		EsRectangle *region = (EsRectangle *) argument1;
	...
	} else if (type == LT_SYSCALL_WINDOW_SET_OPAQUE_BOUNDS) {
		// TODO.
	} else if (type == LT_SYSCALL_WINDOW_SET_SOLID) {
		// TODO.
	} else if (type == LT_SYSCALL_WINDOW_CLOSE) {
		Object *object = (Object *) argument0;
		if (object->window == recentMenu) recentMenu = NULL;
		DestroyWindow(object->window);
	} else if (type == LT_SYSCALL_WINDOW_MOVE) {
		Object *object = (Object *) argument0;
		EsRectangle *region = (EsRectangle *) argument1;
		
		if (argument3 & LT_MOVE_WINDOW_HIDDEN) {
	...
	} else if (type == LT_SYSCALL_CLIPBOARD_HAS) {
		return false; // TODO.
	} else if (type == LT_SYSCALL_CREATE_THREAD) {
	...
	} else if (type == LT_SYSCALL_TERMINATE_THREAD) {
		if (argument0 == LT_CURRENT_THREAD) {
			TerminateThread(GetCurrentThread(), 0);
		} else {
			Object *object = (Object *) argument0;
			TerminateThread(object->handle, 0);
		}
	} else if (type == LT_SYSCALL_WAIT) {
		Object **handles = (Object **) argument0;
		size_t handleCount = argument1;
		int timeout = argument2;
		HANDLE handles2[LT_MAX_WAIT_COUNT];

		for (uintptr_t i = 0; i < handleCount; i++) {
			handles2[i] = handles[i]->handle;
		}

		int result = WaitForMultipleObjects(handleCount, handles2, FALSE, timeout == LT_WAIT_NO_TIMEOUT ? INFINITE : timeout);
		return result == WAIT_TIMEOUT ? LT_ERROR_TIMEOUT_REACHED : result;
	} else if (type == LT_SYSCALL_SET_CURSOR_POSITION) {
		SetCursorPos(argument0, argument1);
	} else if (type == LT_SYSCALL_GET_CREATION_ARGUMENT) {
	...
	} else if (type == LT_SYSCALL_MEMORY_FAULT_RANGE) {
	} else if (type == LT_SYSCALL_WINDOW_SET_MATERIAL) {
	} else {
...
void WinMainCRTStartup() {
	...
	EsMessage m = {};
	m.type = LT_MSG_INSTANCE_CREATE;
	m.createInstance.window = EsSyscall(LT_SYSCALL_WINDOW_CREATE, LT_WINDOW_NORMAL, 0, 0, 0);
