...
SET CFLAGS=%2 -g -fno-exceptions -Ibin -I. -DLT_ARCH_X86_64 -DLT_BITS_64 -DNO_API_TABLE -DUSE_PLATFORM_HEAP -DUSE_HARFBUZZ -DUSE_FREETYPE -DUSE_STB_SPRINTF -Wall -Wextra -Wno-empty-body -Wno-deprecated-declarations -Wno-unknown-pragmas -Wno-unknown-attributes -Wno-c99-designator -Wno-missing-field-initializers -Wno-unused-parameter -Wno-unused-variable -Wno-unused-function
SET LINKFLAGS=/DEBUG /NOLOGO /NODEFAULTLIB /IGNORE:4217 /subsystem:windows /OPT:REF /OPT:ICF /STACK:0x100000,0x100000
SET APPFLAGS=-D_start=_ApplicationStart -DLT_FORWARD -DLT_EXTERN_FORWARD=LT_EXTERN_C -DLT_DIRECT_API

clang -o bin\header_generator.exe util\header_generator.c %CFLAGS%
bin\header_generator c bin\light.h

clang++ -o bin\desktop.o -c desktop\api.cpp -DOS_LIGHT %CFLAGS%
