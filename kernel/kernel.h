...
#define MM_CRITICAL_AVAILABLE_PAGLT_THRESHOLD     (1048576 / K_PAGE_SIZE)             

// The number of pages at which balancing starts.
#define MM_LOW_AVAILABLE_PAGLT_THRESHOLD          (16777216 / K_PAGE_SIZE)            

// The number of pages past MM_LOW_AVAILABLE_PAGLT_THRESHOLD to aim for when balancing.
#define MM_PAGLT_TO_FIND_BALANCE                  (4194304 / K_PAGE_SIZE)             
...
#define MM_OBJECT_CACHE_PAGLT_MAXIMUM()           ((pmm.commitLimit - MM_NON_CACHE_MEMORY_PAGES()) / 2)
