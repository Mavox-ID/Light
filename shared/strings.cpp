...
#define SYSTEM_BRAND_SHORT "Light"
...
DEFINE_INTERFACE_STRING(POSIXUnavailable, "This application depends on the POSIX subsystem (busybox). To enable it, select \am]Flag.ENABLE_POSIX_SUBSYSTEM\a] in \am]config\a].");
DEFINE_INTERFACE_STRING(POSIXTitle, "Terminal");
...
DEFINE_INTERFACE_STRING(InstallerVolumeLabel, "Light HD");
